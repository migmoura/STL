import { b as e, r as t } from "./utils-Cw5qLqcS.js";
import { Et as n, J as r, ft as i, nt as a, q as o, ut as s, wt as c, xt as l } from "./react-w7ldCLEn.js";
import { t as u } from "./dist-DI7OemzC.js";
...
i();
var qe = B, Je = n({}), Ye = ({ ...e }) => /* @__PURE__ */ a(Je.Provider, {
	value: { name: e.name },
	children: /* @__PURE__ */ a(ae, { ...e })
}), Xe = () => {
	let e = c(Je), t = c(Ze), { getFieldState: n } = oe(), r = F({ name: e.name }), i = n(e.name, r);
...
function et({ ...t }) {
	let { error: n, formItemId: r, formDescriptionId: i, formMessageId: o } = Xe();
	return /* @__PURE__ */ a(e, {
...
function tt({ className: e, ...n }) {
	let { error: r, formMessageId: i } = Xe(), o = r ? String(r?.message ?? "") : n.children;
...
function nt({ className: e, children: n, type: i = "", ...o }) {
	let { errors: s } = F();
	return Object.values(s).filter((e) => e?.type === i).length === 0 ? null : /* @__PURE__ */ a("p", {
		"data-slot": "form-error-message",
		className: t("flex gap-4 items-center text-gray-1", e),
		...o,
		children: [/* @__PURE__ */ a(r, { className: "size-5 2xl:size-6 text-light-red" }), n]
	});
}
function rt({ className: e, children: n, ...r }) {
	let { isSubmitSuccessful: i } = F();
	return i ? /* @__PURE__ */ a("p", {
		"data-slot": "form-success-message",
		className: t("flex gap-4 items-center text-gray-1", e),
		...r,
		children: [/* @__PURE__ */ a(o, { className: "size-5 2xl:size-6 text-light-green" }), n]
	}) : null;
}
