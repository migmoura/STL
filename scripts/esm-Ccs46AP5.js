...
import { ft as n, ut as r } from "./react-w7ldCLEn.js";
...
function f({ attributes: e = {}, className: t, children: n = null, selfClose: i = !1, tagName: a }) {
	let o = a;
	return i ? /* @__PURE__ */ r.createElement(o, d({ className: t }, e)) : /* @__PURE__ */ r.createElement(o, d({ className: t }, e), n);
}
var p = class {
	attribute(e, t) {
		return t;
...
var T = class {
	...
	parseNode(e, t) {
		let { noHtml: n, noHtmlExceptMatchers: i, allowElements: a, transform: o, transformOnlyAllowList: s } = this.props, c = [], l = "";
		return [...e.childNodes].forEach((e) => {
			if (e.nodeType === y) {
				...
				if (o && !(s && !this.isTagAllowed(u))) {
					...
					if (t === null) return;
					if (t !== void 0) {
						c.push(/* @__PURE__ */ r.cloneElement(t, { key: e }));
						return;
					}
					this.keyIndex = e - 1;
				}
				if (this.banned.has(u)) return;
				if (!(n || i && u !== "br") && this.isTagAllowed(u) && (a || this.canRenderChild(t, d))) {
					this.keyIndex += 1;
					let e = this.extractAttributes(p), t = { tagName: u };
					e && (t.attributes = e), d.void && (t.selfClose = d.void), c.push(/* @__PURE__ */ r.createElement(f, {
						...t,
						key: this.keyIndex
					}, m ?? this.parseNode(p, d)));
				} else c = [...c, ...this.parseNode(p, d.tagName ? d : t)];
			} else if (e.nodeType === b) {
				let r = n && !i ? e.textContent : this.applyMatchers(e.textContent || "", t);
				Array.isArray(r) ? c = [...c, ...r] : l += r;
			}
		}), l && c.push(l), c;
	}
	replaceTokens(e, t) {
...
function E(e) {
	let { attributes: t, className: n, containerTagName: i, content: a, emptyContent: o, parsedContent: s, tagName: c, noWrap: l } = e, u = i ?? c ?? "span", d = u === "fragment" ? !0 : l, p;
	if (s) p = s;
	else {
		let t = new T(a ?? "", e).parse();
		t.length > 0 && (p = t);
	}
	return p ||= o, d ? /* @__PURE__ */ r.createElement(r.Fragment, null, p) : /* @__PURE__ */ r.createElement(f, {
		attributes: t,
		className: n,
		tagName: u
	}, p);
...
function D(e) {
	let { attributes: t, className: n, content: i = "", disableFilters: a = !1, disableMatchers: o = !1, emptyContent: s = null, filters: c = [], matchers: l = [], onAfterParse: u = null, onBeforeParse: d = null, tagName: f = "span", noWrap: p = !1, ...m } = e, h = o ? [] : l, g = a ? [] : c, _ = d ? [d] : [], v = u ? [u] : [];
	h.forEach((e) => {
