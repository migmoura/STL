...
import { $ as t, X as n, et as r, pt as i, rt as a } from "./react-DLNUXPF9.js";
import { a as o, c as s, d as c, f as l, i as u, l as d, n as f, o as p, r as m, s as h, t as g, u as _ } from "./dist-B9_sdD5H.js";
...
function b({ className: n, size: r = "default", children: i, action: o, ...s }) {
	return /* @__PURE__ */ a("span", {
		className: "relative block",
		children: [/* @__PURE__ */ a(_, {
			"data-slot": "select-trigger",
			"data-size": r,
			className: e("group leading-label flex items-center pl-6 pr-1 relative h-16 gap-4 bg-white ring-1 ring-gray-15 outline-none focus-visible:ring-pressed not-disabled:hover:ring-2 hover:ring-gray-15 disabled:text-gray-25 disabled:ring-gray-3 aria-invalid:ring-light-red aria-invalid:ring-2", n),
			...s,
			children: [/* @__PURE__ */ a("span", {
				...
				asChild: !0,
				children: /* @__PURE__ */ a(t, { className: e("size-6 shrink-0", { "mr-20": !!o }) })
			})]
		}), /* @__PURE__ */ a("span", {
...
function S({ className: t, children: n, ...i }) {
	return /* @__PURE__ */ a(m, {
		...
		className: e("active:bg-gray-35 focus-visible:bg-gray-4 w-full relative flex cursor-default items-center gap-2 px-6 py-5 leading-label outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:text-gray-25", t),
		...i,
		children: [/* @__PURE__ */ a("span", {
			className: "absolute right-2 flex size-3.5 items-center justify-center",
			children: /* @__PURE__ */ a(u, { children: /* @__PURE__ */ a(r, { className: "size-4" }) })
