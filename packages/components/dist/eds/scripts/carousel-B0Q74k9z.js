...
import { Ct as n, Et as r, N as i, P as a, Tt as o, bt as s, ft as c, ht as l, nt as u, wt as d } from "./react-w7ldCLEn.js";
import { t as f } from "./useTranslation-D2-izOQw.js";
...
function Y({ orientation: t = "horizontal", opts: r, setApi: i, plugins: a, className: c, children: l, ...d }) {
	let [p, m] = we({
		...r,
		axis: t === "horizontal" ? "x" : "y"
	}, a), [h, g] = s(!1), [_, v] = s(!1), { t: y } = f(), b = n((e) => {
...
function De({ className: n, variant: r = "tertiary", disabledVariant: i = "tertiary", size: o = "icon", ...s }) {
	let { scrollPrev: c, canScrollPrev: l } = J(), { t: d } = f();
	return /* @__PURE__ */ u(t, {
		...
		onClick: c,
		...s,
		children: [/* @__PURE__ */ u(a, {}), /* @__PURE__ */ u("span", {
			className: "sr-only",
			children: d("Previous slide")
		})]
	});
}
function Oe({ className: n, variant: r = "tertiary", disabledVariant: a = "tertiary", size: o = "icon", ...s }) {
	let { scrollNext: c, canScrollNext: l } = J(), { t: d } = f();
	return /* @__PURE__ */ u(t, {
		...
		onClick: c,
		...s,
		children: [/* @__PURE__ */ u(i, {}), /* @__PURE__ */ u("span", {
			className: "sr-only",
