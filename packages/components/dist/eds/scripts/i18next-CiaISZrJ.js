...
import { t } from "./i18next-Bnts7JEk.js";
import { r as n } from "./useTranslation-D2-izOQw.js";
...
if (typeof ActiveXObject == "function" && (typeof global < "u" && global.ActiveXObject ? h = global.ActiveXObject : typeof window < "u" && window.ActiveXObject && (h = window.ActiveXObject)), typeof p != "function" && (p = void 0), !p && !m && !h) try {
	import("./browser-ponyfill-C3w8tzAs.js").then((t) => /* @__PURE__ */ e(t.default, 1)).then(function(e) {
		p = e.default;
	}).catch(function() {});
} catch {}
var g = function(e, t) {
