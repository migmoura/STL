...
import { Dt as n, Ot as r, dt as i, ft as a, ot as o, pt as s, wt as c } from "./react-w7ldCLEn.js";
import { n as l } from "./i18next-Bnts7JEk.js";
import { a as u, c as d, i as f, l as p, n as m, o as h, s as g, u as _ } from "./useTranslation-D2-izOQw.js";
//#endregion
...
var E = (e, t) => {
	...
	if (r === "") return [];
	let p = c.transKeepBasicHtmlNodesFor || [], m = r && new RegExp(p.map((e) => `<${e}`).join("|")).test(r);
	if (!e && !t && !m && !f) return [r];
	let _ = t ?? {}, v = (e) => {
		k(e).forEach((e) => {
	...
	let y = N(r, p, _), b = T.parse(`<0>${y}</0>`), x = {
		...
		e.dummy ? (e.children = t, n.push(s(e, { key: r }, i ? void 0 : t))) : n.push(...o.map([e], (e) => {
		...
		return k(r).reduce((e, r, l) => {
			...
			if (r.type === "tag") {
				...
				else if (D) C(y, w(s, r.children, o), e, l);
				else if (Number.isNaN(parseFloat(r.name))) if (O) C(y, S(y, r, o), e, l, r.voidElement);
				else if (c.transSupportBasicHtmlNodes && p.indexOf(r.name) > -1) if (r.voidElement) e.push(n(r.name, { key: `${r.name}-${l}` }));
				else {
					let t = w(s, r.children, o);
				...
				let t = c.transWrapTextNodes, i = typeof c.unescape == "function" ? c.unescape : u().unescape, o = f ? i(a.services.interpolator.interpolate(r.content, x, a.language)) : a.services.interpolator.interpolate(r.content, x, a.language);
	...
	let a = e.key || t, o = s(e, { key: a });
	if (!o.props || !o.props.children || i.indexOf(`${t}/>`) < 0 && i.indexOf(`${t} />`) < 0) return o;
	function c() {
		return n(r, null, o);
	}
	return n(c, { key: a });
...
a();
function V({ children: e, count: t, parent: n, i18nKey: r, context: i, tOptions: a = {}, values: o, defaults: s, components: l, ns: u, i18n: d, t: p, shouldUnescape: h, ...g }) {
	let { i18n: _, defaultNS: v } = c(m) || {}, y = d || _ || f(), b = p || y?.t.bind(y);
	return B({
		children: e,
		count: t,
		parent: n,
