import { Ct as e, Et as t, S as n, Tt as r, bt as i, ft as a, ht as o, vt as s, wt as c } from "./react-w7ldCLEn.js";
...
var j = n(), M = {
	...
	let { i18n: a } = n, { i18n: l, defaultNS: u } = c(k) || {}, f = a || l || D();
	...
	let _ = s(() => ({
		...
		...f?.options?.react,
		...n
	}), [f, n]), { useSuspense: v, keyPrefix: y } = _, b = t || u || f?.options?.defaultNS, x = g(b) ? [b] : b || ["translation"], S = s(() => x, x);
	...
	let C = o(0), T = e((e) => {
		...
		_,
		n.lng
	]), [P, F] = i(0), { t: I, ready: L } = (0, j.useSyncExternalStore)(T, O, O);
	r(() => {
		if (f && !L && !v) {
			let e = () => F((e) => e + 1);
