import { Ct as e, G as t, H as n, Ot as r, at as i, dt as a, ft as o, lt as s, nt as c, ot as l, pt as u } from "./react-w7ldCLEn.js";
...
o();
var g = Symbol.for("react.lazy"), _ = s.use;
function v(e) {
...
/* @__NO_SIDE_EFFECTS__ */
function b(e) {
	let t = /* @__PURE__ */ S(e), n = i((e, n) => {
		let { children: r, ...i } = e;
		y(r) && typeof _ == "function" && (r = _(r._payload));
		let o = l.toArray(r), s = o.find(w);
		if (s) {
			let e = s.props.children, r = o.map((t) => t === s ? l.count(e) > 1 ? l.only(null) : a(e) ? e.props.children : null : t);
			return /* @__PURE__ */ c(t, {
				...i,
				ref: n,
				children: a(e) ? u(e, void 0, r) : null
			});
		}
		return /* @__PURE__ */ c(t, {
			...i,
...
function S(e) {
	let t = i((e, t) => {
		let { children: n, ...i } = e;
		if (y(n) && typeof _ == "function" && (n = _(n._payload)), a(n)) {
			let e = E(n), a = T(i, n.props);
			return n.type !== r && (a.ref = t ? m(t, e) : e), u(n, a);
		}
...
function w(e) {
	return a(e) && typeof e.type == "function" && "__radixId" in e.type && e.type.__radixId === C;
}
function T(e, t) {
	let n = { ...t };
	for (let r in t) {
...
o();
function M({ children: e, variant: r = "link", size: i = "default", title: a, ...o }) {
	let s = I(o.href), l = L(o.href);
	return /* @__PURE__ */ c(j, {
		variant: r,
		size: i,
		asChild: !0,
		children: /* @__PURE__ */ c("a", {
			...o,
			title: a === e ? void 0 : a,
			"aria-label": a === e ? void 0 : a,
			target: s || l ? "_blank" : void 0,
			children: [
				e,
				l ? /* @__PURE__ */ c(t, { className: "size-5" }) : null,
				!l && s ? /* @__PURE__ */ c(n, { className: "size-5" }) : null
			]
		})
	});
}
...
function U(e, t) {
	if (e.tagName === "A") return /* @__PURE__ */ c(M, {
