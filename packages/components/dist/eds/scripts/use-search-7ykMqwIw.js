import { i as e } from "./utils-Cw5qLqcS.js";
import { Ct as t, Tt as n, bt as r, ft as i, vt as a } from "./react-w7ldCLEn.js";
import { t as o } from "./index-x5LGNNyK.js";
import { C as s, D as c, E as l, S as u, T as d, _ as f, a as p, b as m, c as h, d as g, f as _, g as v, h as y, i as b, l as x, m as S, o as C, p as w, r as T, s as E, v as ee, w as te, x as ne, y as D } from "./constants-W6IuTVo3.js";
...
var $ = async (e) => fetch(e).then((e) => e.json()).then((e) => e.data), Ae = async (e) => Promise.all(e.map($)).then((e) => e.flat() || []), je = (e, i, s) => {
	let [c, l] = r(0), [u, d] = r(s?.offset ?? 0), f = a(() => s?.sort, [s?.sort]), [p, m] = r({
		count: 0,
		hits: []
	}), [h, g] = r(!1), _ = s?.limit ?? 12, [v] = r(() => Oe());
	o(i, typeof i == "string" ? $ : Ae, {
		revalidateOnFocus: !1,
		keepPreviousData: !0,
		onSuccess: async (e) => {
			ke(v, e), l(Date.now());
