import { i as e, r as t, v as n } from "./utils-Cw5qLqcS.js";
import { K as r, O as i, Q as a, Tt as o, bt as s, ft as c, nt as l } from "./react-w7ldCLEn.js";
import { t as u } from "./tag-CVOOa_z9.js";
import { t as d } from "./useTranslation-D2-izOQw.js";
import { a as f, n as p, t as m } from "./sheet-DONXsLqL.js";
import { n as h, r as g, s as _, t as v } from "./dropdown-menu-C-G7Ntkq.js";
import { t as y } from "./checkbox-D7WFlB1v.js";
...
c();
function Q({ label: t, options: r, selected: i, onSelectionChange: c }) {
	let [f, p] = s(!1), [m, y] = s({}), { t: b } = d();
	o(() => {
		if (f) {
			let e = {};
	...
	return /* @__PURE__ */ l(v, {
		...
		children: [/* @__PURE__ */ l(_, {
			...
			children: [e(r).map(([e, t]) => /* @__PURE__ */ l(h, {
				...
				children: /* @__PURE__ */ l("label", {
					...
					children: [t.label, /* @__PURE__ */ l("span", { children: t.count ? `(${t.count})` : "" })]
				})
			}, e)), /* @__PURE__ */ l("div", {
				...
				children: [/* @__PURE__ */ l(n, {
					...
					type: "submit",
					onClick: () => {
						c(e(m).filter(([e, t]) => t).map(([e]) => e)), p(!1);
					},
					children: b("Save")
				})]
			})]
...
c();
function $({ label: t, options: r, selected: i, onSelectionChange: a }) {
	let [c, h] = s(!1), [g, _] = s({}), { t: v } = d();
	o(() => {
		if (c) {
			let e = {};
			Object.keys(r).forEach((t) => {
			...
			children: [/* @__PURE__ */ l("div", {
				...
				children: /* @__PURE__ */ l(f, {
					...
					children: /* @__PURE__ */ l(n, {
						className: "w-full",
						onClick: () => {
							a(e(g).filter(([e, t]) => t).map(([e]) => e)), h(!1);
						},
						children: v("Apply")
					})
				})
...
c();
function ye({ filters: n, years: o, selected: c, selectedYears: f, onSelectionChange: p, onYearsChange: m, className: y, sortOptions: b, currentSort: x, onSortChange: S }) {
	let [C, w] = s(x), { t: T } = d();
	return /* @__PURE__ */ l("div", {
		className: t("flex flex-wrap items-center gap-2", y),
		children: [
			n.hidden ? null : /* @__PURE__ */ l(Q, {
				label: n.label,
				options: n.records,
				selected: c,
				onSelectionChange: p
			}),
			o && f && m && !o.hidden ? /* @__PURE__ */ l(Q, {
				label: o.label,
				options: o.records,
				selected: f,
				onSelectionChange: m
			...
			/* @__PURE__ */ l("div", {
				...
				children: [
					c.map((e) => /* @__PURE__ */ l(u, {
						variant: "secondary",
						onClick: () => {
							p(c.filter((t) => t !== e));
						},
						children: [n.records[e]?.label, /* @__PURE__ */ l(r, { className: "size-3 m-0.5" })]
					}, e)),
					f && m && o ? f.map((e) => /* @__PURE__ */ l(u, {
						variant: "secondary",
						onClick: () => {
							m(f.filter((t) => t !== e));
						},
						children: [o.records[e]?.label, /* @__PURE__ */ l(r, { className: "size-3 m-0.5" })]
					}, e)) : null,
					c.length > 0 ? /* @__PURE__ */ l(u, {
						variant: "tertiary",
						className: "mr-2",
						onClick: () => {
							p([]);
						},
						children: ["Delete all", /* @__PURE__ */ l(i, { className: "size-4" })]
					}) : null
				]
			}),
			/* @__PURE__ */ l($, {
			...
			b && C ? /* @__PURE__ */ l(v, { children: [/* @__PURE__ */ l(_, {
				...
				className: "w-full",
				children: e(b).map(([e, t], n) => /* @__PURE__ */ l(h, {
					variant: "outline",
					checked: ve(C, t),
					onCheckedChange: () => {
						w(e), S?.(e);
