//#region ../../node_modules/.pnpm/i18next@25.8.18_typescript@5.8.3/node_modules/i18next/dist/esm/i18next.js
...
function k(e, t) {
	...
	if (n.length > 1 && i) {
		let e = t?.ns;
		if ((e ? Array.isArray(e) ? e : [e] : []).includes(n[0])) return `${n[0]}${i}${n.slice(1).join(r)}`;
	}
	return n.join(r);
}
var A = {}, j = (t) => !e(t) && typeof t != "boolean" && typeof t != "number", M = class t extends w {
	...
	interpolate(t, r, i, a) {
		let o, s, c, l = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, u = (e) => {
			if (e.indexOf(this.formatSeparator) < 0) {
				let t = L(r, l, e, this.options.keySeparator, this.options.ignoreJSONStructure);
			...
			return this.format(L(r, l, n, this.options.keySeparator, this.options.ignoreJSONStructure), o, i, {
				...a,
				...r,
				interpolationkey: n
			});
	...
	loaded(e, t, n) {
		...
		this.queue.forEach((n) => {
			l(n.loaded, [i], a), W(n, e), t && n.errors.push(t), n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach((e) => {
				o[e] || (o[e] = {});
				let t = n.loaded[e];
...
}), q = (t) => (e(t.ns) && (t.ns = [t.ns]), e(t.fallbackLng) && (t.fallbackLng = [t.fallbackLng]), e(t.fallbackNS) && (t.fallbackNS = [t.fallbackNS]), t.supportedLngs?.indexOf?.("cimode") < 0 && (t.supportedLngs = t.supportedLngs.concat(["cimode"])), typeof t.initImmediate == "boolean" && (t.initAsync = t.initImmediate), t), J = () => {}, Y = (e) => {
	Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((t) => {
		typeof e[t] == "function" && (e[t] = e[t].bind(e));
	});
}, X = "__i18next_supportNoticeShown", Z = () => typeof globalThis < "u" && !!globalThis[X], Q = () => {
	typeof globalThis < "u" && (globalThis[X] = !0);
}, ee = (e) => !!(e?.modules?.backend?.name?.indexOf("Locize") > 0 || e?.modules?.backend?.constructor?.name?.indexOf("Locize") > 0 || e?.options?.backend?.backends && e.options.backend.backends.some((e) => e?.name?.indexOf("Locize") > 0 || e?.constructor?.name?.indexOf("Locize") > 0) || e?.options?.backend?.projectId || e?.options?.backend?.backendOptions && e.options.backend.backendOptions.some((e) => e?.projectId)), $ = class n extends w {
	constructor(e = {}, t) {
		if (super(), this.options = q(e), this.services = {}, this.logger = C, this.modules = { external: [] }, Y(this), t && !this.isInitialized && !e.isClone) {
	...
	init(n = {}, r) {
		...
		this.options = {
			...
			...i.interpolation,
			...this.options.interpolation
		}, n.keySeparator !== void 0 && (this.options.userDefinedKeySeparator = n.keySeparator), n.nsSeparator !== void 0 && (this.options.userDefinedNsSeparator = n.nsSeparator), typeof this.options.overloadTranslationOptionHandler != "function" && (this.options.overloadTranslationOptionHandler = i.overloadTranslationOptionHandler), this.options.showSupportNotice !== !1 && !ee(this) && !Z() && (typeof console < "u" && console.info !== void 0 && console.info("🌐 i18next is made possible by our own product, Locize — consider powering your project with managed localization (AI, CDN, integrations): https://locize.com 💙"), Q());
		...
		if (!this.options.isClone) {
			...
			let n = this.services;
			n.logger = C, n.resourceStore = this.store, n.languageUtils = t, n.pluralResolver = new I(t, {
	...
	reloadResources(e, n, r) {
		let i = t();
		return typeof e == "function" && (r = e, e = void 0), typeof n == "function" && (r = n, n = void 0), e ||= this.languages, n ||= this.options.ns, r ||= J, this.services.backendConnector.reload(e, n, (e) => {
			i.resolve(), r(e);
		}), i;
	}
	use(e) {
	...
	getFixedT(t, n, r) {
		let i = (e, t, ...n) => {
			...
			return a.keyPrefix && Array.isArray(e) ? s = e.map((e) => (typeof e == "function" && (e = k(e, {
				...this.options,
				...t
			})), `${a.keyPrefix}${o}${e}`)) : (typeof e == "function" && (e = k(e, {
				...this.options,
				...t
