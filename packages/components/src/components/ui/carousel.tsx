...
function CarouselItem({ className, fullWidth = true, ...props }: CarouselItemProps) {
...
function CarouselPrevious({
  className,
  variant = "tertiary",
  disabledVariant = "tertiary",
  size = "icon",
  ...props
}: React.ComponentProps<typeof Button> & {
  disabledVariant?: React.ComponentProps<typeof Button>["variant"];
}) {
  ...
  return (
    <Button
      ...
      variant={canScrollPrev ? variant : disabledVariant}
      size={size}
...
function CarouselNext({
  ...
  return (
    <Button
      ...
      variant={canScrollNext ? variant : disabledVariant}
      size={size}
      className={cn(className)}
