import { f as e, h as t, s as n, t as r } from "../../scripts/parser-Bc1VLsF3.js";
import { n as i, r as a } from "../../scripts/utils-Cw5qLqcS.js";
import { E as o, Tt as s, bt as c, ft as l, nt as u } from "../../scripts/react-w7ldCLEn.js";
...
import { n as f, r as p, t as m } from "../../scripts/carousel-B0Q74k9z.js";
import "../../scripts/picture-DtJCwEBx.js";
import { a as h } from "../../scripts/dist-BPI1VaeD.js";
import "../../scripts/skeleton-amY4T5vv.js";
import { n as g } from "../../scripts/teaser-BSOk0Trv.js";
import { t as _ } from "../../scripts/carousel-pagination-BAi4RXjZ.js";
import { t as v } from "../../scripts/embla-carousel-wheel-gestures.esm-BsjAoK7B.js";
...
function b({ items: e, title: t }) {
	let [n, r] = c(), [o, l] = c(0), d = i(e, 3);
	return s(() => {
		n && (l(n.selectedScrollSnap() + 1), n.on("select", () => {
			l(n.selectedScrollSnap() + 1);
		}));
	}, [n]), /* @__PURE__ */ u(m, {
		opts: { align: "center" },
		"aria-label": `${t} - Slider`,
...
function S({ items: e, ...t }) {
	let n = h("(width >= 80rem)");
	return console.log(n), console.log(window.matchMedia("(width >= 80rem)")), /* @__PURE__ */ u("div", { children: [/* @__PURE__ */ u("div", {
		className: "fluid",
		children: /* @__PURE__ */ u(d, { ...t })
	}), u(n ? b : x, { items: e })] });
}
//#endregion
