import { f as e, u as t } from "../../scripts/parser-Bc1VLsF3.js";
import { r as n } from "../../scripts/utils-Cw5qLqcS.js";
import { E as r, bt as i, ft as a, ht as o, nt as s } from "../../scripts/react-w7ldCLEn.js";
import { t as c } from "../../scripts/picture-DtJCwEBx.js";
...
function l({ pictures: e, caption: t, defaultValue: r = 50 }) {
	...
	let [a, l] = i(r), u = Math.min(100, Math.max(0, a)), d = o(null), f = o(!1), p = (e) => {
...
function u(n) {
	let [i, a, o] = Array.from(n.children), c = {
		pictures: [e(i.querySelector("picture")), e(a.querySelector("picture"))],
		caption: t(o?.textContent)
	};
	r(n).render(/* @__PURE__ */ s(l, { ...c }));
}
//#endregion
export { u as default };
